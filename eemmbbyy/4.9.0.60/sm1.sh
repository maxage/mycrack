...
echo "-------------------我们的域名：https://www.hexsen.com-------------------"
rm -f Emby.Web.dll
wget https://service.hexsen.com/emby/crackbeta/Emby.Web.dll
rm -f MediaBrowser.Model.dll
wget https://service.hexsen.com/emby/crackbeta/MediaBrowser.Model.dll
rm -f MediaBrowser.Controller.dll
wget https://service.hexsen.com/emby/crackbeta/MediaBrowser.Controller.dll
echo "核心开心完成..."
cd dashboard-ui/embypremiere/
rm -f embypremiere.js
wget https://service.hexsen.com/emby/crackbeta/dashboard-ui/embypremiere/embypremiere.js
chmod 644 embypremiere.js
echo "web 开心完成..."
cd ../../
rm -f Emby.Server.Implementations.dll
wget https://service.hexsen.com/emby/crackbeta/Emby.Server.Implementations.dll
